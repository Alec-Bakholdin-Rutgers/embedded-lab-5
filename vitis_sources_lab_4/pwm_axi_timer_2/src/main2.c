...
/*
 * Each duty cycle of PWM is called a step
 */
#define PWM_PERIOD              5000000      /* PWM period in (500 ms) */
#define CYCLES_PER_STEP         10           /* Clock cycles per step */
#define STEPS_PER_PULSE       	10           /* Duty cycle Divisor */
...
int TmrCtrLogic(XTmrCtr *TmrCtrInstancePtr) {
						...
						u16 DeviceId, u16 IntrId)
{
	...
	Status = TmrCtrLogic(TmrCtrInstancePtr);
